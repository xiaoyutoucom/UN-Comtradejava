...
public class WorlddataController {
    ...
    public R orders() {
        try {
            ...
            String[] start_year = {"2017"};//,"2010","2011","2012","2013","2014","2015","2016",
            String[] USER_AGENTS = {
            ...
            for(int y=0;y<start_year.length;y++) {
                ...
                //{
                    ...
                    while(ift) {
                        try{
                            String url="https://comtrade.un.org/api/get?r=all&p=0&ps=" + start_year[y] + "&px=H3&rg=1,2&freq=A&type=C&cc=TOTAL&fmt=json";
